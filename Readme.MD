# Automated Fact-Checking datasets, benchmarks and related resources 


| Dataset   | Website | Public? | Type | Queries  | Corpus |
| -------- | -----| ---------| ------- | --------- | ----------- | ---------| ---------| :----------: | :------:|
| FEVER    | [Homepage](https://fever.ai/resources.html)| ✅ | ``train``<br>``dev``<br>``test``|  6,980   |  8.84M |
...
- [Benchmarks Diverse Topics](#benchmarks-diverse-topics)
- [QA Based Systems](#qa-based-systems)
...
[[Paper]](https://aclanthology.org/2021.acl-short.86/)
...
* Fact Checking with Insufficient Evidence
  [[Paper]](https://aclanthology.org/2022.tacl-1.43.pdf)
 
*  An Extensible Framework for Verification of Numerical Claims
  [[Paper]](https://aclanthology.org/E17-3010/)
...
## Generative modeling
* GERE: Generative Evidence Retrieval for Fact Verification [[Paper]](https://arxiv.org/abs/2204.05511)
* Generating Literal and Implied Subquestions to Fact-check Complex Claims [[Paper]](https://arxiv.org/abs/2205.06938)
...
## Benchmarks Diverse Topics
* A Benchmark Dataset for Automatic Detection of Claims and Evidence in the Context of Controversial Topics
 [[Paper]](https://aclanthology.org/W14-2109/)


## QA bases systems
* AnswerFact: Fact Checking in Product Question Answering [[Paper]](https://aclanthology.org/2020.emnlp-main.188/)
* Generating Literal and Implied Subquestions to Fact-check Complex Claims [[Paper]](https://arxiv.org/abs/2205.06938)
* FAVIQ: FAct Verification from Information-seeking Questions (Park et al., 2022)
  [[Paper]](https://arxiv.org/abs/2106.05707) [[Dataset]](https://faviq.github.io/)
